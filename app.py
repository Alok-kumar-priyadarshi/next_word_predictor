...
# load the LSTM model
model = load_model('next_word_lstm_2.h5')
...
input_text = st.text_input("Enter your sequence of words" , "To be not to be")

if st.button("predict Next word"):
    max_sequence_len = model.input_shape[1]+1 #retrive the max sequence length
